...
\begin{itemize}  
	...
	\item \textbf{N3.js:\footnote{\url{https://github.com/rdfjs/N3.js/}}} La bilioteca N3 ofrece, además de almacenamiento de tripletas en memoria en \textit{Javascript} nativo, facilidades de serialización y procesado con formatos estándar como \textit{Turtle, N3, N-Triples y TriG}. Si bien su conformidad con la especificación de interfaces\textit{ RDF.js} no es completa, sí está presente en gran parte de sus módulos (\textit{DataFactory, StreamParser, StreamWriter y Store}).
\end{itemize}

Confirmadas las limitaciones de \textit{RDF-Ext Dataset} y consultado con el \textit{W3C RDFJS Community Group}, se opta finalmente por utilizar \textbf{N3.js} (lo que supuso adaptar ligeramente la implementación del proyecto al nuevo \textit{storage}).
...
A pesar de todo, N3 nunca se convirtió en un estándar y sus características adicionales frente a \textit{N-Triples} no tuvieron mucha aceptación.
...
\end{table}
	...
	\begin{tabular}{p{2cm}p{3cm}p{11cm}}
		...
		ACC-7 & Importar N3 & Importa un grafo en formato \textit{N3, Turtle, TriG o N-Triples}. \\ \midrule
		ACC-8 & Añadir N3 &  Añade al grafo existente otro en formato \textit{N3, Turtle, TriG o N-Triples}. \\ \midrule
		ACC-9 & Eliminar N3 & Elimina del grafo local las ternas existentes en otro grafo en formato \textit{N3, Turtle, TriG o N-Triples} \\ \midrule
