...
\subsection{Dar de alta una nueva anotación o propiedad estándar de una clase}
...
\subsection{Editar una propiedad o anotación de una clase}
...
\subsection{Eliminar una propiedad o anotación de una clase}
...
\begin{enumerate}
	\item Flujo básico
	\begin{enumerate}
		\item El usuario pulsa en importar archivo o rellena la URL del mismo y pulsa en el icono con forma de lupa.
