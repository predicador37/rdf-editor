...
\subsection{Dar de alta una nueva clase o propiedad}\label{sec:dar-de-alta-una-nueva-clase}

\subsubsection{Descripción breve}

Este caso de uso permite a un usuario añadir una nueva clase/propiedad a su grafo a través de una tripleta que tendrá como sujeto el nombre de la clase/propiedad), como objeto el recurso \textit{owl:Class},  \textit{owl:DatatypeProperty} o \textit{owl:ObjectProperty} (según el caso) y como predicado el recurso \textit{rdf:type}. Se agrupan clases y propiedades en el mismo caso de uso porque son idénticos salvo por el tipo de recursos utilizados para dar de alta las ternas.
...
El caso de usa comienza cuando el usuario pulsa en el botón flotante + asociado a la tarjeta del listado de clases/propiedades.

\subsubsection{Flujo de eventos}
\begin{enumerate}
	\item Flujo básico
	\begin{enumerate}
		\item El usuario pulsa en el botón flotante + asociado a la tarjeta del listado de clases/propiedades.
		\item Aparece un cuadro de diálogo donde el usuario debe introducir el nombre de la clase/propiedad.
...
\subsection{Editar una clase o propiedad existente}\label{sec:editar-una-clase-existente}
...
El caso de uso comienza cuando el usuario pulsa en el icono de menú asociado a la clase/propiedad que quiere editar y selecciona la acción ``Editar''.

\subsubsection{Flujo de eventos}
\begin{enumerate}
	\item Flujo básico
	\begin{enumerate}
		\item El usuario pulsa en el icono de menú asociado a la clase/propiedad que quiere editar y selecciona la acción ``Editar''.
...
El usuario debe haber navegado previamente hasta la sección de modelado, bien a través de la pantalla de bienvenida, bien a través de la barra de navegación lateral y haber seleccionado una de las dos pestañas disponibles (clases o propiedades).
...
\subsection{Eliminar una clase o propiedad existente}\label{sec:eliminar-una-clase-existente}
...
El caso de usa comienza cuando el usuario pulsa en el icono de menú asociado a la clase/propiedad que quiere editar y selecciona la acción ``Eliminar''.

\subsubsection{Flujo de eventos}
\begin{enumerate}
	\item Flujo básico
	\begin{enumerate}
		\item El usuario pulsa en el icono de menú asociado a la clase/propiedad que quiere editar y selecciona la acción ``Eliminar''.
...
\subsection{Dar de alta una nueva anotación de una clase o propiedad}\label{sec:dar-de-alta-una-nueva-anotacion-o-propiedad-estandar-de-una-clase}

\subsubsection{Descripción breve}

Este caso de uso permite a un usuario añadir una nueva anotación de una clase/propiedad a su grafo. Tan sólo se podrán añadir anotaciones o propiedades descriptivas de entre las previamente configuradas en el código fuente de la aplicación (es decir, han de fijarse de manera previa, si bien su extensión es sencilla). La configuración por defecto ofrece una lista de las propiedades más utilizadas.
...
\subsection{Editar una anotación de una clase/propiedad}\label{sec:editar-una-propiedad-o-anotacion-de-una-clase}

\subsubsection{Descripción breve}

Este caso de uso permite a un usuario editar el recurso asociado a una anotación de una clase/propiedad existente en su grafo y cambiar su URI. Tan sólo se podrá editar una anotación de entre las previamente configuradas en el código fuente de la aplicación (es decir, han de fijarse de manera previa, si bien su extensión es sencilla).
...
\begin{enumerate}
	\item Flujo básico
\begin{enumerate}
	\item El usuario pulsa en el icono de menú asociado a la anotación de la clase/propiedad que quiere editar y selecciona la acción ``Editar''.
	\item Aparece un cuadro de diálogo con el URI del recurso actual que el usuario puede modificar.
	\item El usuario modifica (o no) el URI del recurso  y pulsa en guardar.
...
Este caso de uso permite a un usuario eliminar el recurso asociado a una anotación de una clase existente en su grafo. Tan sólo se podrá eliminar una anotación de entre las previamente configuradas en el código fuente de la aplicación (es decir, han de fijarse de manera previa, si bien su extensión es sencilla).
...
El caso de usa comienza cuando el usuario pulsa en el icono de menú asociado a la anotación de clase/propiedad que quiere editar y selecciona la acción ``Eliminar''.

\subsubsection{Flujo de eventos}
\begin{enumerate}
	\item Flujo básico
	\begin{enumerate}
		\item El usuario pulsa en el icono de menú asociado a la anotación de la clase/propiedad que quiere editar y selecciona la acción ``Eliminar''.
		\item Aparece un cuadro de diálogo advirtiendo al usuario de que si confirma el cambio, no podrá volver a recuperar el recurso del grafo.
	\item El usuario pulsa fuera del cuadro de diálogo.
	\item El cuadro de diálogo se cierra y no hay ningún cambio en los recursos.
	\end{enumerate}
