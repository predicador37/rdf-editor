...
Este caso de uso permite a un usuario añadir una nueva clase a su grafo a través de una tripleta que tendrá como sujeto el nombre de la clase, como objeto el recurso \textit{owl:Class} y como predicado el recurso \textit{rdf:type}. 
