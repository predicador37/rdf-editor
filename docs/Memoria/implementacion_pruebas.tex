...
El resultado fue la plantilla \textit{webpack}\footnote{Webpack es un empaquetador de módulos para JS. Ver \url{https://github.com/vuetifyjs/webpack} y \url{https://webpack.js.org/}}, que presenta las siguientes características:
...
Para desplegar la aplicación a modo de demostración se ha optado por utilizar \textit{Firebase}\footnote{\url{https://firebase.google.com/}}, una plataforma de desarrollo de \textit{Google}, a modo de PaaS\footnote{\textit{Platform as a Service}: entorno de desarrollo e implementación en la nube.}. Si bien \textit{Firebase} provee de muchos servicios en la nube (como base de datos, autenticación, almacenamiento, etc.) para este proyecto tan solo ha sido necesario utilizar el servicio de alojamiento. Para ello, basta con incluir un par de sencillos ficheros de configuración con el siguiente contenido:
...
Dado el abrumador número de ontologías disponibles\footnote{Ejemplo: lista de ontologías de Protégé en \url{https://protegewiki.stanford.edu/wiki/Protege_Ontology_Library}}, para la implementación de la funcionalidad de modelado en el presente proyecto se ha optado por incluir en memoria un subconjunto de ternas pertenecientes a los vocabularios más utilizados. Usando como referencia \cite{evanstaylor01}, las sugerencias del Director del proyecto y criterios relacionados con el alcance de la funcionalidad implementable para esta primera versión, se ha decidido dar soporte a las estructuras listadas en el cuadro \ref{tab:model-constructs}
	...
	\begin{tabular}{p{4cm}p{10cm}}
		...
		rdf:type &  Permite definir una relación entre una instancia y su clase correspondiente. \\ \midrule
		rdf:Class & Categoría para clasificar recursos.  \\ \midrule
		rdfs:subClassOf & Indica que todas las instancias de una clase lo son también de la clase padre. \\ \midrule
		rdfs:subPropertyOf &  Indica que un recurso asociado a otro con una propiedad también lo está por su propiedad padre. \\ \midrule
		rdfs:domain & Colección de tipos que usan una propiedad. \\ \midrule
		...
		owl:Class & Categoría para clasificar recursos o individuos. Es subclase de \textit{rdf:Class}.  \\ \midrule
		...
		owl:equivalentProperty & Indica que dos propiedades tienen la misma extensión (conjunto de instancias asociadas).  \\ \midrule
		owl:disjointWith &  Implica que los conjuntos de individuos de las clases que relaciona no tienen ninguna instancia en común. \\ \midrule
		owl:propertyDisjointWith &  Implica que los conjuntos de individuos de las propiedades que relaciona no tienen ninguna instancia en común.\\ \midrule
		rdfs:label & Proporciona una versión legible del nombre de un recurso. \\ \midrule
		rdfs:comment & Proporciona una versión legible de la descripción de un recurso. \\ \midrule
		rdfs:seeAlso & Indica que el recurso relacionado podría proporcionar información adicional sobre el sujeto. \\ 
...
Sin pretender entrar a fondo en los detalles de la implementación, que puede consultarse en el repositorio de código fuente del proyecto en: \url{https://github.com/predicador37/rdf-editor}, sí se ha considerado conveniente documentar determinadas decisiones:
	...
	\end{itemize}
\item En el módulo de actividades, la importación a Markdown se realiza mediante la biblioteca \textit{vue-markdown}\footnote{https://github.com/miaolz123/vue-markdown}, que a su vez utiliza \textit{markdown-it}\footnote{https://github.com/markdown-it/markdown-it}. Esta última biblioteca implementa un procesador del formato \textit{Markdown} con buen rendimiento y conforme a la especificación \textit{CommonMark Spec} 0.28\footnote{\url{https://spec.commonmark.org/}}, si bien añade extensiones de sintaxis (como tablas y tachados de \textit{Github Flavored Markdown}\footnote{La sintaxis de Markdown propuesta por Github, que añade características como tablas, estilo de texto, etc. Ver \url{https://help.github.com/articles/basic-writing-and-formatting-syntax/\#styling-text}}) y otros aspectos.
