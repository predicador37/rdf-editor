...
En la filosofía del Test Driven Development (o TDD), primero se codifica la prueba unitaria y después se implementa la lógica a probar. Este enfoque permite garantizar niveles razonables de calidad en el desarrollo de software. En el presente proyecto no se ha seguido estrictamente debido a la naturaleza del desarrollo, muy orientado a la interfaz gráfica; no obstante, sí se han incluido las pruebas unitarias consideradas como críticas para garantizar un correcto funcionamiento general de la aplicación. Esto, junto con distintos detalles de implementación, se discute en el presente capítulo.
