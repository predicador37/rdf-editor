...
\begin{itemize}
	...
	\item Encuesta de \textit{Gartner}\cite{mieritz01}.
\end{itemize}
...
Para gestionar estas tareas, se optó por utilizar como herramienta Kanban\footnote{\url{https://es.atlassian.com/agile/kanban}}. Un tablero Kanban puede definirse como un dispositivo de señalización que introduce el flujo de trabajo de un proceso a un ritmo manejable. Presenta las siguientes características:
